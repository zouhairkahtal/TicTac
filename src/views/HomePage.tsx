...
<footer className="bg-green-900">
    <div className="mx-auto w-full max-w-screen-xl">
      <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-3">
        ...
        <div>
            <h2 className="mb-6 text-sm font-semibold text-white">Help center</h2>
            <ul className="text-gray-300 font-medium">
                <li className="mb-4">
    ...
    <div className="px-4 py-6 bg-green-800 md:flex md:items-center md:justify-between">
        <span className="text-smtext-gray-300 sm:text-center text-gray-50">© 2025 TicTac. All Rights Reserved.
        </span>
